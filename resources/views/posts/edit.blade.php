<x-app-layout>
    <div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
        <h2 class="text-xl font-bold mb-4">ویرایش پست</h2>
        ...
        <form action="{{ route('posts.update', $post->id) }}" method="POST" class="space-y-4" enctype="multipart/form-data">
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="5" required
                          class="mt-1 block w-full rounded border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('content', $post->content) }}</textarea>
            </div>
            ...
            <div>
                ...
                @if($post->photo_path)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $post->photo_path) }}" alt="تصویر فعلی" class="h-32 object-cover">
